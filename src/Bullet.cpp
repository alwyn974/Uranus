...
Bullet::Bullet(registry &r, component::position pos) : _entity(r.spawn_entity())
{
    ...
    r.add_component(e2, component::collisionable{0, 0, 20, 20, [&](registry &r, const size_t &entity, const size_t &entity_colliding_with){this->colliding(r, entity, entity_colliding_with);}});
